...
public class Hel2 {
     ...
     */
    public Hel2(int xCoordinate, int yCoordinate)
    {
    ...
    private void LoadContent()
    {
        try 
        {
            URL helicopterBodyImgUrl = this.getClass().getResource("/com/game/action/resources/images/heli2.png");
            ...
            Logger.getLogger(Hel2.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        // Now that we have images of propeller animation we initialize animation object.
        helicopterFrontPropellerAnim = new Animation(helicopterFrontPropellerAnimImg, 204, 34, 3, 20, true,(int)(Framework.frameWidth*0.665), (int)(Framework.frameHeight*0.221) , 0);
        helicopterRearPropellerAnim = new Animation(helicopterRearPropellerAnimImg, 54, 54, 4, 20, true,(int)(Framework.frameWidth*0.8749),(int)(Framework.frameHeight*0.229), 0);
    }
