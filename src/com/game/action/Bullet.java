...
public class Bullet {
    ...
    // Damage that is made to an EnemyHelicopter when it is hit with a bullet.
    ...
    // Images of player machine gun bullet. Image is loaded and set in Game class in LoadContent() method.
